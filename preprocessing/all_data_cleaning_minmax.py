...
with open('../datasets/enne.csv') as csv_file:
    ...
    for row in csv_reader:
        ...
        # newRow.append('type2' if eventsDict['bloodGlucose'] > 9 else 'normal')

        newRow.append(eventsDict['diastolic'])
        newRow.append(eventsDict['systolic'])
        newRow.append(eventsDict['heartrate'])
...
print('glucoDropCount', glucoDropCount)
print('orignal len after drop ', len(df))
